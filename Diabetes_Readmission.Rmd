...
```{r KNN Confusion Matrix 2}
confusionMatrix(df.test2$readmitted,
                y_pred)
```

K-Nearest Neighbor confusion matrix results:
* Accuracy: 0.6833
* Kappa: 0.3133
